...
const Menu = () => {
  return (
    <div className="flex w-full md:h-[100vh] px-2 md:w-[10vw] justify-between fixed bottom-0 z-[9999] bg-white flex-row md:flex-col items-center md:items-start md:min-h-[80vh] md:gap-[6vh] md:pl-[1.3vw] md:pr-[6vw] lg:w-[20vw]">
